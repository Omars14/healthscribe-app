...
# ============================================
# COMPLETE SELF-HOSTED SUPABASE MIGRATION
# ============================================

set -e  # Exit on any error

echo "🧹 STEP 1: CLEANUP VPS"
echo "======================"
...
# Create the complete schema for plain PostgreSQL (not Supabase)
...
CREATE POLICY "Users can view own user data" ON auth.users
    FOR SELECT USING (true); -- Allow authenticated users to see their own data
