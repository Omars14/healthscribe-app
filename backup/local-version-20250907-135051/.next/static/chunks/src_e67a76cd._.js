...
"[project]/src/app/test-deployment/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": ()=>DeploymentTestPage
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
...
function DeploymentTestPage() {
    ...
    const runTest = async (index, testFunction)=>{
        updateTest(index, {
            status: 'running'
        });
        try {
    ...
    const testSupabaseConnection = async ()=>{
        try {
            ...
            const { supabase } = await __turbopack_context__.r("[project]/src/lib/supabase.ts [app-client] (ecmascript, async loader)")(__turbopack_context__.i);
    ...
    const testAuthentication = async ()=>{
        try {
            ...
            return {
                ...
                message: data.user ? "Logged in as ".concat(data.user.email) : 'Not authenticated',
                details: {
                    userId: (_data_user = data.user) === null || _data_user === void 0 ? void 0 : _data_user.id,
        ...
        try {
            ...
            if (listError) {
                return {
                    ...
                    details: {
                        ...
                        suggestion: 'Check your Supabase service role key and storage permissions'
                    }
                };
            }
            console.log('🔍 Available buckets:', buckets === null || buckets === void 0 ? void 0 : buckets.map((b)=>b.name));
            console.log('🔍 Looking for bucket: "audio-files"');
            const audioFilesBucket = buckets === null || buckets === void 0 ? void 0 : buckets.find((b)=>b.name === 'audio-files');
            if (!audioFilesBucket) {
                console.log('❌ Bucket "audio-files" not found in available buckets');
                // Check for similar bucket names
                const similarBuckets = (buckets === null || buckets === void 0 ? void 0 : buckets.filter((b)=>b.name.includes('audio') || b.name.includes('file') || b.name.includes('media'))) || [];
                return {
                    name: 'File Upload',
                    status: 'error',
                    message: 'Storage bucket "audio-files" not found',
                    details: {
                        availableBuckets: (buckets === null || buckets === void 0 ? void 0 : buckets.map((b)=>b.name)) || [],
                        similarBuckets: similarBuckets.map((b)=>b.name),
                        suggestion: similarBuckets.length > 0 ? "Found similar buckets: ".concat(similarBuckets.map((b)=>b.name).join(', '), '. Rename one to "audio-files" or create new bucket.') : 'Create bucket named "audio-files" in Supabase Dashboard > Storage',
                        troubleshooting: [
            ...
            for (const testFile of testFiles){
                try {
                    ...
                    const { uploadDirectToStorage } = await __turbopack_context__.r("[project]/src/lib/direct-upload-service.ts [app-client] (ecmascript, async loader)")(__turbopack_context__.i);
                    ...
                    if (!result.error) {
                        return {
                            name: 'File Upload',
                            status: 'success',
                            message: "File uploaded successfully using ".concat(testFile.type),
                            details: {
    ...
    const testStorageAccess = async ()=>{
        try {
            ...
            if (error) {
                if (error.message.includes('permission') || error.message.includes('unauthorized')) {
                    return {
                        ...
                        details: {
                            error: error.message,
                            suggestion: 'Configure storage permissions in Supabase'
                        }
                    };
                }
                return {
            ...
            console.log('🔍 Storage Access Test - Available buckets:', data === null || data === void 0 ? void 0 : data.map((b)=>b.name));
            console.log('🔍 Storage Access Test - Looking for: "audio-files"');
            const audioFilesBucket = data === null || data === void 0 ? void 0 : data.find((bucket)=>bucket.name === 'audio-files');
            if (!audioFilesBucket) {
                console.log('❌ Storage Access Test - Bucket "audio-files" not found');
                // Check for similar bucket names
                const similarBuckets = (data === null || data === void 0 ? void 0 : data.filter((b)=>b.name.includes('audio') || b.name.includes('file') || b.name.includes('media'))) || [];
                return {
                    name: 'Storage Access',
                    status: 'error',
                    message: 'Storage accessible but "audio-files" bucket missing',
                    details: {
                        buckets: data === null || data === void 0 ? void 0 : data.map((b)=>b.name),
                        similarBuckets: similarBuckets.map((b)=>b.name),
                        suggestion: similarBuckets.length > 0 ? "Found similar buckets: ".concat(similarBuckets.map((b)=>b.name).join(', '), '. Rename one to "audio-files" or create new bucket.') : 'Create "audio-files" bucket in Supabase Storage',
                        troubleshooting: [
        ...
        try {
            ...
            if (!(session === null || session === void 0 ? void 0 : session.access_token)) {
                return {
                    ...
                    details: {
                        suggestion: 'User must be logged in to test API endpoints'
                    }
                };
            }
    ...
    const testTranscriptionFlow = async ()=>{
        try {
            // Test transcription service import
            const { submitTranscription } = await __turbopack_context__.r("[project]/src/lib/transcription-service.ts [app-client] (ecmascript, async loader)")(__turbopack_context__.i);
            return {
                name: 'Transcription Flow',
                status: 'success',
                message: 'Transcription service loaded',
                details: {
                    serviceAvailable: !!submitTranscription
                }
            };
        } catch (error) {
            return {
        ...
        switch(status){
            case 'success':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$check$2d$big$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckCircle$3e$__["CheckCircle"], {
                    ...
                    fileName: "[project]/src/app/test-deployment/page.tsx",
                    lineNumber: 456,
                    columnNumber: 16
                }, this);
            case 'error':
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                            children: "Test all critical functionality before deploying to Vercel"
                        }, void 0, false, {
                            fileName: "[project]/src/app/test-deployment/page.tsx",
                            lineNumber: 487,
                            columnNumber: 11
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-blue-50 dark:bg-blue-950/20 p-4 mx-6 mb-0 rounded-lg border border-blue-200 dark:border-blue-800",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                            className: "font-semibold text-blue-900 dark:text-blue-100 mb-2 flex items-center gap-2",
                            children: "🔍 Current Supabase Project"
                        }, void 0, false, {
                            fileName: "[project]/src/app/test-deployment/page.tsx",
                            lineNumber: 494,
                            columnNumber: 11
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "font-mono bg-blue-100 dark:bg-blue-900/30 p-2 rounded mb-2",
                                    children: "https://yaznemrwbingjwqutbvb.supabase.co"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/test-deployment/page.tsx",
                                    lineNumber: 498,
                                    columnNumber: 13
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-xs",
                                    children: "If the bucket exists in a different project, that's why the tests are failing."
                                }, void 0, false, {
                                    fileName: "[project]/src/app/test-deployment/page.tsx",
                                    lineNumber: 504,
                                    columnNumber: 13
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$refresh$2d$cw$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__RefreshCw$3e$__["RefreshCw"], {
                                            className: "h-4 w-4 ".concat(isRunning ? 'animate-spin' : '')
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/test-deployment/page.tsx",
                                            lineNumber: 517,
                                            columnNumber: 15
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: tests.map((test, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                    className: "transition-all ".concat(getStatusColor(test.status)),
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                        className: "p-4",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                children: [
                                                                    ...
                                                                    test.message && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                                        variant: test.status === 'success' ? 'default' : test.status === 'error' ? 'destructive' : test.status === 'running' ? 'secondary' : 'outline',
                                            ...
                                            test.details && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "mt-3 p-3 bg-background/50 rounded text-xs font-mono",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20 p-6 rounded-lg border",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                    className: "font-semibold text-lg mb-4 flex items-center gap-2",
                                    children: "🚀 Deployment Readiness Summary"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/test-deployment/page.tsx",
                                    lineNumber: 568,
                                    columnNumber: 13
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h4", {
                                                    className: "font-medium mb-2 text-green-700 dark:text-green-300",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h4", {
                                                    className: "font-medium mb-2 text-orange-700 dark:text-orange-300",
                                                    children: "⚠️ May Need Attention:"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/test-deployment/page.tsx",
                                                    lineNumber: 585,
                                                    columnNumber: 17
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                            children: "• Storage Bucket Config"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/test-deployment/page.tsx",
                                                            lineNumber: 587,
                                                            columnNumber: 19
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                            children: "• File Upload Permissions"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/test-deployment/page.tsx",
                                                            lineNumber: 589,
                                                            columnNumber: 19
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                    ...
                                    children: "📤 File Upload Destination"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/test-deployment/page.tsx",
                                    lineNumber: 597,
                                    columnNumber: 13
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: [
                                        ...
                                        " (not Vercel). This ensures unlimited file sizes and reliable storage."
                                    ]
                                }, void 0, true, {
                                    fileName: "[project]/src/app/test-deployment/page.tsx",
                                    lineNumber: 600,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                            variant: "outline",
                                            children: "✅ Bypasses Vercel 4.5MB limit"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/test-deployment/page.tsx",
                                            lineNumber: 605,
                                            columnNumber: 15
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "bg-yellow-50 dark:bg-yellow-950/20 p-4 rounded-lg border border-yellow-200 dark:border-yellow-800",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                    className: "font-semibold text-yellow-900 dark:text-yellow-100 mb-2",
                                    children: "🔧 Fix Storage Issues (Most Common):"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/test-deployment/page.tsx",
                                    lineNumber: 614,
                                    columnNumber: 13
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                                    ...
                                                    children: "1. Create Storage Bucket:"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/test-deployment/page.tsx",
                                                    lineNumber: 619,
                                                    columnNumber: 17
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ol", {
                                                    className: "text-yellow-700 dark:text-yellow-300 mt-1 ml-4 list-decimal",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                            children: [
                                                                "Go to ",
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                            children: "Go to Storage → Create bucket"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/test-deployment/page.tsx",
                                                            lineNumber: 623,
                                                            columnNumber: 19
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                            children: "Keep it private (not public)"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/test-deployment/page.tsx",
                                                            lineNumber: 625,
                                                            columnNumber: 19
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                                    className: "text-yellow-800 dark:text-yellow-200",
                                                    children: "2. Configure MIME Types:"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/test-deployment/page.tsx",
                                                    lineNumber: 630,
                                                    columnNumber: 17
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: "In bucket settings, add these MIME types:"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/test-deployment/page.tsx",
                                                    lineNumber: 631,
                                                    columnNumber: 17
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "mt-2 font-mono text-xs bg-gray-100 dark:bg-gray-700 p-2 rounded",
                                                    children: [
                                                        "audio/*",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                                    className: "text-yellow-800 dark:text-yellow-200",
                                                    children: "3. Alternative: Run Setup Script"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/test-deployment/page.tsx",
                                                    lineNumber: 643,
                                                    columnNumber: 17
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("code", {
                                                            className: "block mt-1 p-2 bg-gray-100 dark:bg-gray-700 rounded text-xs",
                                                            children: "node setup-supabase-storage.js"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/test-deployment/page.tsx",
                                                            lineNumber: 646,
                                                            columnNumber: 19
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            children: [
                                                "✅ ",
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                                    children: "Transcription Service:"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/test-deployment/page.tsx",
                                                    lineNumber: 664,
                                                    columnNumber: 20
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "mt-3 p-3 bg-green-100 dark:bg-green-900/30 rounded",
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: [
                                            ...
                                            " Configure storage bucket, then you'll be ready to deploy to Vercel! 🚀"
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/app/test-deployment/page.tsx",
                                        lineNumber: 667,
...
_s(DeploymentTestPage, "f7PJ+Iz3bjqy91vwxrc7Q27xRG4=");
_c = DeploymentTestPage;
var _c;
__turbopack_context__.k.register(_c, "DeploymentTestPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_e67a76cd._.js.map