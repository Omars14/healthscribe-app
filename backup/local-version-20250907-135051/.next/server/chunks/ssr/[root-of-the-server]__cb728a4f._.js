...
"[project]/src/lib/direct-upload-service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
async function uploadDirectToStorage({ file, userId, bucketName = 'audio-files' }) {
    try {
        // Generate unique file name
        const timestamp = Date.now();
        const fileExt = file.name.split('.').pop() || 'mp3';
        const fileName = `${timestamp}-${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$esm$2f$v4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])()}.${fileExt}`;
        ...
        const { data: { publicUrl } } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from(bucketName).getPublicUrl(filePath);
...
async function createSignedUrl(bucketName, path, expiresIn = 3600) {
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from(bucketName).createSignedUrl(path, expiresIn);
...
"[project]/src/lib/transcription-service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/supabase.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$direct$2d$upload$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/direct-upload-service.ts [app-ssr] (ecmascript)");
;
;
...
async function submitTranscription(request) {
    try {
        ...
        const uploadResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$direct$2d$upload$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uploadDirectToStorage"])({
...
async function checkTranscriptionStatus(transcriptionId) {
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('transcriptions').select('id, status, transcription_text, audio_url, error').eq('id', transcriptionId).single();
        if (error) {
...
async function pollTranscriptionStatus(transcriptionId, onUpdate, maxAttempts = 60, intervalMs = 5000) {
    let attempts = 0;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cb728a4f._.js.map