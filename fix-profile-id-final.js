...
async function main() {
  ...
  try {
    ...
    console.log('🔧 Fixing Profile ID and Final Test...\n');
...
SELECT 'Profile created with ID:' as status, id, email, role 
FROM public.user_profiles 
WHERE email = 'omars14@gmail.com';
SQL
`);

    // Get token and test profile via API
