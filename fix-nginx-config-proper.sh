...
echo "🔧 FIXING NGINX CONFIGURATION - PROPER CORS SETUP"
echo "=================================================="

# Step 1: Remove the broken configuration
echo "Step 1: Removing broken Nginx configuration..."
rm -f /etc/nginx/sites-enabled/supabase.healthscribe.pro
rm -f /etc/nginx/sites-available/supabase.healthscribe.pro

# Step 2: Create a proper Nginx configuration with correct CORS placement
echo "Step 2: Creating proper Nginx configuration..."
...
EOF
    ...
    echo "============================="
    echo "✅ Proper CORS headers in location blocks"
