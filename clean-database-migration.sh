...
echo "🚀 Clean Database Migration for Medical Transcription System"
echo "=========================================================="
...
# Create fresh Supabase environment
cat > .env << EOF
...
print_info "Step 4: Creating fresh Docker Compose configuration"
