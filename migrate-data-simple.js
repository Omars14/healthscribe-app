...
/**
 * Simple Data Migration Script: Cloud Supabase to PostgreSQL
 * 
 * This script migrates your data from the cloud Supabase instance
 * to a simple PostgreSQL database.
 */
...
const POSTGRES_CONFIG = {
  ...
  password: 'healthscribe_password_2024',
  port: 5432,
};
...
async function main() {
  ...
  if (failedTables === 0 && verificationResult) {
    ...
    console.log('5. Get SSL certificates: certbot --nginx -d www.healthscribe.pro');
